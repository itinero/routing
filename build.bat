...
dotnet build ./samples/Sample.Elevation -r ubuntu.16.04-x64
dotnet build ./samples/Sample.Elevation -r win10-x64
dotnet build ./samples/Sample.Elevation -r osx.10.11-x64