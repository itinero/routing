...
namespace Itinero.Test
{
    ...
    public class RouterManyToManyTests
    {
        ...
        /// </summary>
        [Test]
        public void TestDirectedEdgeBasedManyToManyWeights()
        {
            var eMeter = 20f;
            ...
            var weights = router.TryCalculateWeight(vehicle, directedIds, directedIds);

            // matrix of distance results:
            //       1F   1B   2F   2B   3F   3B  
            // 1F [   0, 400, 470, 400, 340, 580]
            // 1B [ 400,   0, 600,   0, 470, 180]
            // 2F [   0, 400,   0, 630, 500, 740]
            // 2B [ 600, 470,1220,   0,1090,   0]
            // 3F [ 180, 580,   0, 730,   0, 680]
            // 3B [ 470, 340,1090, 500, 960,   0]
