...
//            var vehicleCache = new VehicleCache(Itinero.Profiles.Vehicle.GetRegistered().ToArray());

//            Assert.IsFalse(tags.Normalize(profileTags, metaTags, vehicleCache, new Whitelist()));

//            tags.AddOrReplace(new Attribute("highway", "residential"));
//            Assert.IsTrue(tags.Normalize(profileTags, metaTags, vehicleCache, new Whitelist()));
...
//            Assert.IsTrue(tags.Normalize(profileTags, metaTags, new VehicleCache(vehicles), new Whitelist()));
//            Assert.IsTrue(profileTags.Contains("highway", "residential"));
