...
namespace Itinero.Test.Algorithms.Networks.Preprocessing
{
    ...
    public class MaxDistanceSplitterTests
    {
        ...
        public void TestWithNoSplits()
        {
            ...
            var splitter = new Itinero.Algorithms.Networks.Preprocessing.MaxDistanceSplitter(network);
            splitter.Run();
        ...
        public void TestWithSplit()
        {
            ...
            var splitter = new Itinero.Algorithms.Networks.Preprocessing.MaxDistanceSplitter(network, 50);
            splitter.Run();
        ...
        public void TestWithSplitWithShape()
        {
            ...
            var splitter = new Itinero.Algorithms.Networks.Preprocessing.MaxDistanceSplitter(network, 300);
            splitter.Run();
