...
namespace Itinero.Test
{
    ...
    public class RouterDbTests
    {
        ...
        public void TestSaveLoadNetwork6()
        {
            ...
            Assert.AreEqual("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7918415,51.268158]},\"properties\":{\"id\":1,\"node_id\":6}}]}",
                json);

            json = routerDb.GetGeoJsonAround(4, 10, true, true, false);
            Assert.AreEqual("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7905326,51.26566]},\"properties\":{\"id\":4,\"node_id\":1}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.787357,51.265648],[4.7905326,51.26566]]},\"properties\":{\"highway\":\"residential\",\"edgeid\":0,\"vertex1\":7,\"vertex2\":4,\"edge_id\":1}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7905326,51.26566],[4.7917557,51.26695]]},\"properties\":{\"highway\":\"residential\",\"oneway\":\"yes\",\"edgeid\":2,\"vertex1\":4,\"vertex2\":3,\"edge_id\":5}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7966695,51.2657],[4.7905326,51.26566]]},\"properties\":{\"highway\":\"residential\",\"oneway\":\"yes\",\"edgeid\":5,\"vertex1\":5,\"vertex2\":4,\"edge_id\":3}}]}",
                json);
        }
        ...
        public void TestGetGeoJsonEdges()
        {
            ...
            Assert.AreEqual("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7966695,51.2657],[4.7905326,51.26566]]},\"properties\":{\"highway\":\"residential\",\"oneway\":\"yes\",\"edgeid\":5,\"vertex1\":5,\"vertex2\":4,\"edge_id\":3}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7966695,51.2657]},\"properties\":{\"id\":5,\"node_id\":2}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7905326,51.26566]},\"properties\":{\"id\":4,\"node_id\":1}}]}",
                json);
            
            json = routerDb.GetGeoJsonEdges(edgeIds: resolved.EdgeId, includeVertices: false, includeProfileDetails: false);
            Assert.AreEqual("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7966695,51.2657],[4.7905326,51.26566]]},\"properties\":{\"highway\":\"residential\",\"oneway\":\"yes\",\"edgeid\":5,\"vertex1\":5,\"vertex2\":4,\"edge_id\":3}}]}",
                json);
            
            json = routerDb.GetGeoJsonEdges(edgeIds: resolved.EdgeId, neighbours: true, includeProfileDetails: false);
            Assert.AreEqual("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7966695,51.2657],[4.7905326,51.26566]]},\"properties\":{\"highway\":\"residential\",\"oneway\":\"yes\",\"edgeid\":5,\"vertex1\":5,\"vertex2\":4,\"edge_id\":3}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7966695,51.2657],[4.7994804,51.2657]]},\"properties\":{\"highway\":\"residential\",\"edgeid\":1,\"vertex1\":5,\"vertex2\":6,\"edge_id\":1}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7957253,51.266937],[4.7966695,51.2657]]},\"properties\":{\"highway\":\"residential\",\"oneway\":\"yes\",\"edgeid\":4,\"vertex1\":2,\"vertex2\":5,\"edge_id\":7}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.787357,51.265648],[4.7905326,51.26566]]},\"properties\":{\"highway\":\"residential\",\"edgeid\":0,\"vertex1\":7,\"vertex2\":4,\"edge_id\":1}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7905326,51.26566],[4.7917557,51.26695]]},\"properties\":{\"highway\":\"residential\",\"oneway\":\"yes\",\"edgeid\":2,\"vertex1\":4,\"vertex2\":3,\"edge_id\":5}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7966695,51.2657]},\"properties\":{\"id\":5,\"node_id\":2}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7905326,51.26566]},\"properties\":{\"id\":4,\"node_id\":1}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7994804,51.2657]},\"properties\":{\"id\":6,\"node_id\":3}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7957253,51.266937]},\"properties\":{\"id\":2,\"node_id\":5}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.787357,51.265648]},\"properties\":{\"id\":7,\"node_id\":0}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7917557,51.26695]},\"properties\":{\"id\":3,\"node_id\":4}}]}",
                json);
        ...
        public void TestGetGeoJsonVertices()
        {
            ...
            Assert.AreEqual("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7966695,51.2657]},\"properties\":{\"id\":5,\"node_id\":2}}]}",
                json);
            ...
            Assert.AreEqual("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7966695,51.2657],[4.7994804,51.2657]]},\"properties\":{\"highway\":\"residential\",\"edgeid\":1,\"vertex1\":5,\"vertex2\":6,\"edge_id\":1}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7957253,51.266937],[4.7966695,51.2657]]},\"properties\":{\"highway\":\"residential\",\"oneway\":\"yes\",\"edgeid\":4,\"vertex1\":2,\"vertex2\":5,\"edge_id\":7}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7966695,51.2657],[4.7905326,51.26566]]},\"properties\":{\"highway\":\"residential\",\"oneway\":\"yes\",\"edgeid\":5,\"vertex1\":5,\"vertex2\":4,\"edge_id\":3}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.787357,51.265648],[4.7905326,51.26566]]},\"properties\":{\"highway\":\"residential\",\"edgeid\":0,\"vertex1\":7,\"vertex2\":4,\"edge_id\":1}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[4.7905326,51.26566],[4.7917557,51.26695]]},\"properties\":{\"highway\":\"residential\",\"oneway\":\"yes\",\"edgeid\":2,\"vertex1\":4,\"vertex2\":3,\"edge_id\":5}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7966695,51.2657]},\"properties\":{\"id\":5,\"node_id\":2}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7994804,51.2657]},\"properties\":{\"id\":6,\"node_id\":3}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7957253,51.266937]},\"properties\":{\"id\":2,\"node_id\":5}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7905326,51.26566]},\"properties\":{\"id\":4,\"node_id\":1}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.787357,51.265648]},\"properties\":{\"id\":7,\"node_id\":0}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[4.7917557,51.26695]},\"properties\":{\"id\":3,\"node_id\":4}}]}",
                json);
        }
    }
}