...
{
    /// <summary>
    /// Represents a potential shortcut.
    /// </summary>
        ...
        where T : struct
    {
        ...
        {
            return string.Format("{0}->{1} {2}F {3}B", this.Vertex1.ToInvariantString(),
                this.Vertex2.ToInvariantString(), this.Forward.ToInvariantString(), 
