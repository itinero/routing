...
namespace Itinero.Profiles.Lua
{
	...
	public sealed class DynValue
	{
		...
		{
			return Itinero.Profiles.Lua.Interop.Converters.ClrToScriptConversions.ObjectToDynValue(script, obj);
		}
		...
		public object ToObject(Type desiredType)
		{
			...
			return Itinero.Profiles.Lua.Interop.Converters.ScriptToClrConversions.DynValueToObjectOfType(this, desiredType, null, false);
		}
