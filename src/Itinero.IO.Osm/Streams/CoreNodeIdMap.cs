...
//    {
//        private readonly UniqueIdMap<uint> _firstMap; // holds the first vertex for a node, will be enough in 99.9% of cases.
...
//        {
//            _firstMap = new UniqueIdMap<uint>(uint.MaxValue);
...
//        {
//            var existingVertex = _firstMap[nodeId];
//            if (existingVertex == uint.MaxValue)
//            {
//                _firstMap[nodeId] = vertex;
//                return;
//            }
...
//        {
//            vertex = _firstMap[nodeId];
//            return vertex != uint.MaxValue;
//        }
...
//            get
//            {
//                return _firstMap.NonDefaultIndices;
//            }
//        }
