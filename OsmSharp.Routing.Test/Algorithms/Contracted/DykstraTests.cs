...
namespace OsmSharp.Routing.Test.Algorithms.Contracted
{
    ...
    public class DykstraTests
    {
        ...
        public void TestOneEdge()
        {
            ...
            var algorithm = new Routing.Algorithms.Contracted.Dykstra(graph, new Path[] { new Path(0) }, false);
            algorithm.Run();
            ...
            // create algorithm and run.
            algorithm = new Routing.Algorithms.Contracted.Dykstra(graph, new Path[] { new Path(1) }, false);
            algorithm.Run();
        ...
        public void TestTwoEdgesMiddleHighest()
        {
            ...
            // create algorithm and run.
            var algorithm = new OsmSharp.Routing.Algorithms.Contracted.Dykstra(graph,
            ...
            // create algorithm and run.
            algorithm = new OsmSharp.Routing.Algorithms.Contracted.Dykstra(graph,
