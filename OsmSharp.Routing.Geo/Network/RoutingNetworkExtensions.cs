...
namespace OsmSharp.Routing.Geo.Network
{
    /// <summary>
    ...
    public static class RoutingNetworkExtensions
    {
            ...
            float maxLatitude, float maxLongitude)
        {
            ...
            var vertices = OsmSharp.Routing.Algorithms.Search.Hilbert.HilbertExtensions.Search(network.GeometricGraph, minLatitude, minLongitude,
